...
public class PdfUtils {
    ...
    private static  Font keyfont = new Font(Font.FontFamily.HELVETICA, 7, Font.NORMAL);;// 设置字体大小
...
/*    static{
    ...
    public void generatePDF() throws Exception{
        ...
        for(int i=0;i<5;i++){
            table.addCell(createCell("姓名"+i, keyfont));
            table.addCell(createCell(i+15+"", keyfont));
            table.addCell(createCell((i%2==0)?"男":"女", keyfont));
            table.addCell(createCell("地址"+i, keyfont));
        }
        document.add(table);
